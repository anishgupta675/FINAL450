...
long long s1[1<<10][1<<10],s2[1<<10][1<<10], ar1[1<<10][1<<10],ar2[1<<10][1<<10],pw1[1<<22],pw2[1<<22],n2,m2;
...
vector<long long> have; bool solve(int X) {
have.clear();
...
if (id!=have.size()&&have[id]==res) return true;
}
return false;
}
int main(){
