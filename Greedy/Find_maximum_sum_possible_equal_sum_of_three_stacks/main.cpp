...
int *stack1 = nullptr, *stack2 = nullptr, *stack3 = nullptr;
...
int main() {
    int n1, n2, n3;
    cin >> n1;
    stack1 = (int *)malloc(n1 * sizeof(int));
    for(int i = 0; i < n1; i++)
        cin >> stack1[i];
    cin >> n2;
    stack2 = (int *)malloc(n2 * sizeof(int));
    for(int i = 0; i < n2; i++)
        cin >> stack2[i];
    cin >> n3;
    stack3 = (int *)malloc(n3 * sizeof(int));
    for(int i = 0; i < n3; i++)
        cin >> stack3[i];
    cout << maxSum(stack1, stack2, stack3, n1, n2, n3) << endl;
    free(stack3); free(stack2); free(stack1);
    return 0;
}